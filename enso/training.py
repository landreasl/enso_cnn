...
for epochs in range(REANALYSIS_EPOCHS):
   ...
   # plt.savefig(f"/Users/andreasbaumgartner/Desktop/enso_training/{PRETRAINING_EPOCHS}_epochs_{LR}_LR_cmip.png")
    ...
    #plt.savefig(f"/Users/andreasbaumgartner/Desktop/enso_training/{PRETRAINING_EPOCHS}_epochs_{LR}_lr.png")
    plt.show()
    # %%
    torch.save(model.state_dict(), PATH + f"/output/cnn_model_{PRETRAINING_EPOCHS}_epochs.pt")
